...
rep_pairs = [
    (0, 1),         # nearest neighbor (first row adjacent)
    (0, 7),         # same row, far end (first row last column)
    (0, 56),        # same column, far end (last row first column)
    (0, 63)        # farthest diagonal (opposite corner)
]
...
# Print summary
print("Mesh Topology Hop Count Summary (4×4)")
