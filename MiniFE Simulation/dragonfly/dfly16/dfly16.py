...
job = {
    ...
    "motifs": [
        ...
        # {"pattern": "PingPong", "params": "rank2=2 iterations=105 messageSize=409 compute=3ns"},
        # {"pattern": "PingPong", "params": "rank2=3 iterations=105 messageSize=82 compute=3ns"},
        # {"pattern": "PingPong", "params": "rank2=5 iterations=105 messageSize=82 compute=3ns"},
        # {"pattern": "PingPong", "params": "rank2=8 iterations=105 messageSize=490 compute=3ns"},
        # {"pattern": "PingPong", "params": "rank2=15 iterations=105 messageSize=490 compute=3ns"}
    ]
}
