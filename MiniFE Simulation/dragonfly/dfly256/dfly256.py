...
job = {
    ...
    "motifs": [
        ...
        # {"pattern": "PingPong", "params": "rank2=12 iterations=105 messageSize=409 compute=3ns"},
        # {"pattern": "PingPong", "params": "rank2=18 iterations=105 messageSize=409 compute=3ns"},
        # {"pattern": "PingPong", "params": "rank2=36 iterations=105 messageSize=82 compute=3ns"},
        # {"pattern": "PingPong","params": "rank2=54 iterations=105 messageSize=82 compute=3ns"},
        # {"pattern": "PingPong", "params": "rank2=72 iterations=105 messageSize=490 compute=3ns"},
        # {"pattern": "PingPong", "params": "rank2=90 iterations=105 messageSize=490 compute=3ns"}
    ]
}
