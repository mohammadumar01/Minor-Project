...
rep_pairs = [
    ...
    (0, 31),  # same row, far end
    (0, 992),  # same column, far end
    (0, 1023)   # farthest diagonal
]
...
# Write to CSV
with open("torus32x32_hopcount_summary.csv", "w", newline="") as f:
    writer = csv.writer(f)
    writer.writerows(rows_avg)

# Print summary
print("Torus Topology Hop Count Summary ")
