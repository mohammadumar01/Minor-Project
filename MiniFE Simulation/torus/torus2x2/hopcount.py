...
rep_pairs = [
    ...
    (0, 2),  # same column, far end
    (0, 3)   # farthest diagonal
]
...
# Write to CSV
with open("torus2x2_hopcount_summary.csv", "w", newline="") as f:
    writer = csv.writer(f)
...
# Additional analysis
print(f"\nDetailed hop count examples for 2×2 torus:")
print("Coordinates: Rank 0=(0,0), Rank 1=(0,1), Rank 2=(1,0), Rank 3=(1,1)")
...
# Explain torus wrap-around
print(f"\nTorus wrap-around explanation:")
print("In a 2×2 torus, opposite edges are connected:")
print("- Horizontal wrap: (0,0) is connected to (0,1) and (1,0) is connected to (1,1)")
print("- Vertical wrap: (0,0) is connected to (1,0) and (0,1) is connected to (1,1)")
print("- Diagonal wrap: (0,0) is connected to (1,1) and (0,1) is connected to (1,0)")