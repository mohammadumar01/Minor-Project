...
def parse_fattree_shape(shape_str):
    ...
    #for fattree shape "4,4:4,4:64"downlinks = [4,4,64]
    pods = downlinks[-1]           # 16 pods
    hosts_per_pod = downlinks[0] * downlinks[1]   # 4*4=16 hosts per pod
...
# Parse FatTree shape
shape_str = "4,4:4,4:64"
pods, hosts_per_pod, downlinks = parse_fattree_shape(shape_str)
total_hosts = pods * hosts_per_pod  # 256 hosts
...
motifs = [
    ...
    {"pattern": "PingPong", "pairs": [(0,13), (1,17), (18,250),(0,255)], "iterations": 105}
]
