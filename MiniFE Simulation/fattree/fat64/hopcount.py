...
def parse_fattree_shape(shape_str):
    ...
    #for fattree shape  "2,2:2,2:16"downlinks = [2,2,16]
...
# Parse FatTree shape
shape_str = "2,2:2,2:16"
pods, hosts_per_pod, downlinks = parse_fattree_shape(shape_str)
total_hosts = pods * hosts_per_pod  # 64 hosts
...
motifs = [
    ...
    {"pattern": "PingPong", "pairs": [(0,1), (0,8), (0,16),(0,32),(0,48)], "iterations": 105}
]
